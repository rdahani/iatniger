...
function admin_sidebar(string $actif): void
{
    $groupes = [
        ...
        'Contenus' => [
            ...
            'a-propos' => ['contenu.php?type=section&groupe=a-propos', 'book-open', 'À propos', 'a-propos'],
            'vie-etudiante' => ['contenu.php?type=section&groupe=vie-etudiante', 'heart', 'Vie étudiante', 'vie-etudiante'],
            'csp' => ['contenu.php?type=section&groupe=csp-algoza', 'school', 'CSP Algoza', 'csp'],
            'admission' => ['contenu.php?type=section&groupe=admission', 'user-plus', 'Admission', 'admission'],
        ],
        'Demandes' => [
